        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <Card 
                key={index} 
                className="border-2 hover:border-primary transition-all duration-500 ease-in-out hover:shadow-xl hover:scale-105 group animate-slide-up opacity-0 border-b-[6px] border-b-secondary"
