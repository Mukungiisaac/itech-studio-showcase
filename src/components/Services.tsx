...
const Services = () => {
  return (
    <section id="services" className="py-24 px-6 shadow-2xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <Card 
                key={index} 
                className="shadow-lg hover:border-primary transition-all duration-500 ease-in-out hover:shadow-2xl hover:scale-105 group animate-slide-up opacity-0 border-b-[6px] border-b-secondary border-t-0 border-x-0"
